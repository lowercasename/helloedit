...
},{"../../addon/mode/overlay":8,"../../lib/codemirror":12,"../markdown/markdown":14}],14:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"../../lib/codemirror":12,"../meta":15,"../xml/xml":16}],15:[function(require,module,exports){
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
...
},{"codemirror":12}],21:[function(require,module,exports){
...
function createDropdown() {
    var fonts = ['Fira Sans','Fira Mono','TimesNewPixel','Pxlvetica','Tamzen'];
...
EasyMDE.prototype.render = function (el) {
    ...
    this.codemirror = CodeMirror.fromTextArea(el, {
        ...
        tabSize: (options.tabSize != undefined) ? options.tabSize : 4,
        indentUnit: (options.tabSize != undefined) ? options.tabSize : 4,
    ...
    this.codemirror.on('renderLine', function(cm, line, elt) {
      ...
      // Show continued list/quote lines aligned to start of text rather
      ...
      var off = CodeMirror.countColumn(leading, leading.length, cm.getOption('tabSize')) * charWidth - 6;
